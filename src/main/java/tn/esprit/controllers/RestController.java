...
public class RestController {
	...
	public float  getFormateurRemunerationByDate(
		...
		return service.getFormateurRemunerationByDate(idFormateur,dateDebut,dateFin);
	}
	
	@GetMapping("/get-formateur-remuneration-by-date2/{idFormateur}/{dateDebut}/{dateFin}")
	public float  getFormateurRemunerationByDate2(@PathVariable Integer idFormateur,@PathVariable String dateDebut,@PathVariable String dateFin) throws ParseException {
